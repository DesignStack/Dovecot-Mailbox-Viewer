...
"""
    ...
    notes = ("Download **Dovecot-Mailbox-Viewer-Windows.exe** below and double-click it. "
             ...
             "**Linux:** download **Dovecot-Mailbox-Viewer-Linux-x86_64.AppImage**, mark it executable "
             "and launch it. Targets x86-64 desktops with glibc 2.35+ and X11/XWayland. "
             "If mounting is restricted, launch with `--appimage-extract-and-run`. "
             "No Python installation is required.\n\n"
             + section.group(1).strip() + "\n\n"
             "`SHA256SUMS.txt` contains checksums for all release assets. "
             "Only the EXE or AppImage for your operating system is needed to run the app.\n\n"
             "**Third-party software:** Qt and PySide/Shiboken are used under LGPLv3. "
             "`Third-party-notices.zip` (Windows) and `Third-party-notices-Linux.zip` contain licence texts, exact dependency versions "
             ...
             "Linux has its own native-file inventory and additional runtime source archives. "
